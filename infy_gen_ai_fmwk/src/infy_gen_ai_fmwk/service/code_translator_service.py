...
from infy_gen_ai_fmwk.data.response_data import CodeTranslatorResponseData
...
class CodeTranslatorService:
    ...
    def __get_translated_code(self, source_code, source_lang, target_lang):
        ...
        if (num_tokens > self.config_data.token_limit):
            logger.info(
                'Token limit reached. Either decrease size of source code or remove a few examples')
